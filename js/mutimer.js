...
var muStyleSheetPath = 'css/mutimer.css';  // path to the mutimer.css
...
function displayTZCountDown(tdiff, config)
{
    if(tdiff < 0) {
        ...
        t += '<div class="clock">';
        t += '    <div class="hr"><p><b>'+hours+'</b>часов</p></div>';
        t += '    <div class="min"><p><b>'+mins+'</b>минут</p></div>';
        t += '    <div class="sec"><p><b>'+secs+'</b>секунд</p></div>';
